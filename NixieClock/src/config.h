...
#define DIGIT_MASK ID(4), ID(6), ID(7), ID(3), ID(8), ID(9), ID(0), ID(1), ID(5), ID(2), ID(10) //порядок пинов лампы(указывать через запятую)(цифра "10" - это пустой символ, должен быть всегда в конце)(ID(0)..ID(10))
#define CATHODE_MASK 1, 6, 2, 7, 5, 0, 4, 9, 8, 3  //порядок катодов в лампе(указывать от первой до последней цифры)(ИН12 - 1, 6, 2, 7, 5, 0, 4, 9, 8, 3 | ИН14 - 1, 0, 2, 9, 3, 8, 4, 7, 5, 6)(0..9)
...
#define WIRE_SLAVE_ADDR 8          //адрес часов в слейв режиме(8..127)
#define WIRE_SLAVE_TIME 3000         //количество циклов для ожидания освобождения шины в слейв режиме(500...10000)
