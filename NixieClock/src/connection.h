...
//Цифровые кнопки
#define SET_PIN   13  //пин кнопки ОК(0..13)(pin D)
#define LEFT_PIN  2  //пин левой кнопки(0..13)(pin D)
...
#define DOT_2_PIN 10  //пин секундных точек(правой неонки)(0..13)(pin D)
...
#define BUZZ_PIN  8  //пин пищалки(бузер - 0..13 | SD карта - 9..10)(pin D)
...
#define SENS_PIN 7 //пин сенсора температуры(для DS18xx и DHTxx)(0..13)(pin D)
